...
public class RuleUnitTest extends TestCase{
    public void test_validate() {
        ...
        assertFalse(rule001.validate());
        assertEquals(rule001.getValidationResult(), R.string.message_validate_rule_percent_last);
        ...
        assertFalse(rule001.validate());
        assertEquals(rule001.getValidationResult(), R.string.message_validate_rule_pair_brackets);
        ...
        assertFalse(rule001.validate());
        assertEquals(rule001.getValidationResult(), R.string.message_validate_rule_pair_brackets);
        rule001=new Rule("bracket before %", "1212D{%}", "+123");
        assertFalse(rule001.validate());
        ...
        assertFalse(rule001.validate());
        assertEquals(rule001.getValidationResult(), R.string.message_validate_rule_invalid_format);
        rule001=new Rule("bad capture char", "1212D{123}", "+123{M12}M3");
        assertFalse(rule001.validate());
        assertEquals(rule001.getValidationResult(), R.string.message_validate_rule_invalid_format);
        rule001=new Rule("too many matches in formula0", "1212D{123}", "+123{M1}{M2}");
        assertFalse(rule001.validate());
        assertEquals(rule001.getValidationResult(), R.string.message_validate_rule_more_match_in_formula);
